...
# 42 "/usr/include/c++/4.4/iomanip" 2 3
...
# 43 "/usr/include/c++/4.4/iomanip" 2 3
...
class bus_route
{
    ...
    void serialize(Archive &ar, const unsigned int version)
    {
        ...
        ar.register_type(static_cast<bus_stop_corner *>(__null));

        ar.register_type(static_cast<bus_stop_destination *>(__null));
